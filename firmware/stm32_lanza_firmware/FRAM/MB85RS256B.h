...
HAL_StatusTypeDef FRAM_Init(MB85RS256B_t *dev);

HAL_StatusTypeDef FRAM_Read(MB85RS256B_t *dev, uint16_t addr, uint8_t *data, size_t len);
HAL_StatusTypeDef FRAM_Write(MB85RS256B_t *dev, uint16_t addr, const uint8_t *data, size_t len);
